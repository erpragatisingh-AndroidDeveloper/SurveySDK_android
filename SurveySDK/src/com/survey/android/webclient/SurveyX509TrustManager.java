...
public class SurveyX509TrustManager implements X509TrustManager 
{  
     ...
     */  
    public SurveyX509TrustManager(KeyStore keystore) throws NoSuchAlgorithmException, KeyStoreException 
    {  
      super();  
      TrustManagerFactory factory = TrustManagerFactory.getInstance(TrustManagerFactory.getDefaultAlgorithm());  
  	  Log.d("EasyX509TrustManager->KeyStore: " + keystore);        
